...
class ButtonSpace extends TelegramButton
{
    protected string $buttonKey = 'space-style';

    protected string $buttonText = 'Космос';
    ...
    public function handle(CallbackQuery $query): ServerResponse
    {
        return Request::sendMessage([
            ...
            'reply_markup'  => ImageKeyboard::make(Style::Space->value)->getKeyboard()
        ]);
    }
}